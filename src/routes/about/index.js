...
const About = () => (
    <section className={style.about}>
        ...
        <p className={style.subtitle}>Цель YANKI — создавать одежду для молодых людей, свободных от стереотипов, ценящих самовыражение и
        ...
        <p className={style.subtitle}>YANKI развивается вместе с клиентами, всегда внимательно следит за новыми технологиями, общественной жизнью,
